...
export default async function AnnouncementDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (annErr) {
    ...
    return <div data-layout-width="centered" className="p-4 md:p-6 max-w-2xl mx-auto"><p className="text-sm text-destructive">Không tải được thông báo. Vui lòng thử lại sau hoặc báo Admin.</p></div>
  }
  if (!ann) notFound()
  ...
  return (
    <div data-layout-width="centered" className="p-4 md:p-6 max-w-2xl mx-auto space-y-4">
